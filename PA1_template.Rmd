...
Mean Steps Taken per Day : `r mean.steps`  
Median Steps Taken Per Day : `r median.steps`  
...
```
Interval With the maximum average number of steps : `r activity.interval.max.avg$interval`
...
```
Number of rows with missing step count : `r na.count`
...
### Post-Impute Values
Mean Steps Taken per Day : `r mean.steps.new`  
Median Steps Taken Per Day : `r median.steps.new`  
